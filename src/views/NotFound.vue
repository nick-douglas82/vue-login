...
<template>
  <main
    class="min-h-full bg-center bg-cover sm:bg-center"
  ...
  >
    <div class="px-4 py-16 mx-auto text-center max-w-7xl sm:px-6 sm:py-24 lg:px-8 lg:py-48">
      ...
      <div class="mt-6">
        <router-link to="/dashboard" class="inline-flex items-center px-4 py-2 text-sm font-medium text-black text-opacity-75 bg-white bg-opacity-75 border border-transparent rounded-md sm:bg-opacity-25 sm:hover:bg-opacity-50"
          >Go back to the Dashboard</router-link
        >
      </div>
    </div>
  </main>
